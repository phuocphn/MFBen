...
for hidden_layers, layer_neurons, temperature in list(
    ...
    command = [
        ...
        "scheme.dataset_dir=datasets/pipn.1/test/ellipse_set2_2,datasets/pipn.1/test/equilateral_hexagon_2,datasets/pipn.1/test/equilateral_octagon_2,datasets/pipn.1/test/rectangle_set2_2,datasets/pipn.1/test/semi_circle_2,datasets/pipn.1/test/square_2,datasets/pipn.1/test/trapezoid_2,datasets/pipn.1/test/triangle_2",
