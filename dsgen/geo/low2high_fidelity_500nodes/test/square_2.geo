...
Point(5) = {cx-a/2, cy - a/2, 0, mesh_size0};
Point(6) = {cx+a/2, cy - a/2, 0, mesh_size0};
Point(7) = {cx+a/2, cy + a/2, 0, mesh_size0};
Point(8) = {cx-a/2, cy + a/2, 0, mesh_size0};
...
Physical Surface("obstacle", 27) = {7, 9, 8, 6};
